...
namespace Nethereum.CheckBalance
{
    ...
    public class TokenBalanceService
    {
        ...
        public TokenBalanceService(HttpClient httpClient, Web3.Web3 web3)
        {
        ...
        {
            var etherBalance = Web3.Web3.Convert.FromWei(await _web3.Eth.GetBalance.SendRequestAsync(account));
